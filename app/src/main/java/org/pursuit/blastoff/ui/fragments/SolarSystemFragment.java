...
import org.pursuit.blastoff.ui.rc.SolarSystemAdapter;
...
public class SolarSystemFragment extends Fragment {
    ...
    public void initRecyclerView(View view) {
        ...
        recyclerView.setAdapter(new SolarSystemAdapter(parsedJSON(view).getSpace().get(0).getSolarSystem(), fragmentListener));
